...
웹 검색 도구를 사용하여 최신 반도체 섹터 뉴스, NVIDIA/TSMC 동향, HBM 관련 소식을 확인하세요.
...
export async function generateSemiconductorReport(
  ...
  const semiKeywords = [
    "semiconductor", "chip", "nvidia", "tsmc", "asml", "samsung", "hynix",
    "반도체", "삼성", "하이닉스", "HBM", "AI칩", "파운드리", "foundry",
    "memory", "DRAM", "NAND", "GPU", "amd", "intel",
  ];
