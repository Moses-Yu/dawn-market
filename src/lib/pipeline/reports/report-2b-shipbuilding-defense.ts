...
웹 검색 도구를 사용하여 최신 조선/방산 뉴스, K-방산 수출, LNG선 수주 동향을 확인하세요.
...
export async function generateShipbuildingDefenseReport(
  ...
  const keywords = [
    "shipbuilding", "defense", "defence", "military", "navy", "missile",
    "drone", "LNG", "vessel", "weapon", "arms", "lockheed", "raytheon",
    "rtx", "northrop", "조선", "방산", "방위", "군수", "한화", "HD현대",
    "해군", "미사일", "드론", "K-방산", "함정", "수주", "LNG선",
  ];
